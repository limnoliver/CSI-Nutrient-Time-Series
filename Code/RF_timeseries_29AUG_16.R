...
geo.pub = lake.predictors[,c(2,1,22,15:21,23:26,40:46,51,47,48,69,49,50,72,73,
                             71,74,75,70,53:64)]
names(geo.pub)[c(4,5,25,28:33)] = c("lat", "long", "hu4_dep_change", "hu4_tmean_1990", 
                                    "hu4_tmean_2011", "hu4_tmean_change", "hu4_ppt_1990",
                                    "hu4_ppt_2011", "hu4_ppt_change")
write.csv(geo.pub, "LAGOS_supporting_geophysical.csv", row.names=FALSE)
test = read.csv("LAGOS_supporting_geophysical.csv", header = TRUE)
